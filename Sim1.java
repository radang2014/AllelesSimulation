 ...
 * of each allele. This method simulates environmental conditions where no allele is favored.
 */
public class Sim1 {
    ...
    public static void main(String args[]) {
        ...
        //Produces 60 offspring using the allele frequency in the parent generation.
        for (int i = 0; i < 60; i++) {
